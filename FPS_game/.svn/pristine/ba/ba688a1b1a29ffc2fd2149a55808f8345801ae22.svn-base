...
void Gun::setMesh(MyMesh _mesh){
	this->mesh = _mesh;
}

void Gun::setPosition(glm::vec3 _position){
...
void Gun::InitGunUsingGlmModel(){
	//use MyMesh to read the .obj, textures and shaders files
	this->mesh.reader.init("external_files/rifle/M40A5.obj","shaders/vl.glsl","shaders/fl.glsl");
	
}

void Gun::draw(glm::mat4 model, glm::mat4 view,glm::mat4 projection, glm::vec3 scale, float alpha, glm::vec3 color){
